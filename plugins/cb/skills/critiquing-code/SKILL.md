...
Run `/cb:critique` with the target:

- **File**: `/cb:critique src/auth/session.ts`
- **Directory**: `/cb:critique src/payments/`
- **Focused**: `/cb:critique --instructions "focus on injection and auth bypass" src/api/`
