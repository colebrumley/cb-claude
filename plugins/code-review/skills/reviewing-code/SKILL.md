...
Run `/review` with appropriate arguments:

- **PR**: `/review <PR-number>` or `/review <branch-range>`
- **Local changes**: `/review` (auto-detects uncommitted changes)
- **Deep review for large changes**: `/review --depth deep`
