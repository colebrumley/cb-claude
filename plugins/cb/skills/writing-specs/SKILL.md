...
Run `/cb:spec` with a description:

- **New feature**: `/cb:spec user authentication with OAuth2 and JWT`
- **Refactor**: `/cb:spec migrate payment processing from Stripe v2 to v3 API`
- **Complex change**: `/cb:spec add real-time collaboration to the document editor`
