...
Run `/cb:docs` with the target:

- **File**: `/cb:docs src/api/routes.ts`
- **Module**: `/cb:docs src/payments/`
- **Typed**: `/cb:docs --type api-reference src/api/`
- **With audience**: `/cb:docs --persona "new team member" src/core/`
